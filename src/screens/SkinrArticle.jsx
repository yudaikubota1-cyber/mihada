...
const ARTICLES = [
  ...
  },
  {
    ...
    concern: '毛穴',
    skinType: null,
    intro: '毛穴の開き・黒ずみの原因は、過剰な皮脂と古い角質の蓄積。BHA（サリチル酸）で毛穴の中の汚れを溶かし、ナイアシンアミドで毛穴を引き締める韓国スキンケアがおすすめです。',
    ingredients: [
      { name: 'BHA（サリチル酸）', desc: '油溶性の酸で毛穴の中に浸透し、皮脂や角栓を溶かす。' },
      { name: 'ナイアシンアミド', desc: '皮脂コントロール+毛穴縮小。肌のキメを整える万能成分。' },
      { name: 'ティーツリー', desc: '清潔ケア・鎮静ケア作用。毛穴トラブルの原因菌にアプローチ。' },
    ],
  ...
  },
  {
    ...
    concern: 'ニキビ',
    skinType: null,
    intro: 'ニキビケアの基本は「鎮静」と「菌のコントロール」。韓国スキンケアはCICA（ツボクサエキス）やドクダミなど、優しく炎症を鎮める成分が豊富。肌に負担をかけずにニキビをケアします。',
    ingredients: [
      { name: 'ツボクサエキス（CICA）', desc: '韓国スキンケアの代表成分。炎症を鎮め、肌の修復をサポート。' },
      { name: 'ドクダミエキス', desc: '清潔ケア・鎮静ケア作用。韓国で古くから使われてきた鎮静成分。' },
      { name: 'アゼライン酸', desc: '毛穴詰まりをケアし、ニキビの原因菌をコントロール。赤みにも働きかけます。' },
    ],
  ...
  },
  {
    ...
    ingredients: [
      { name: 'ビタミンC誘導体', desc: 'メラニン生成をコントロールし、既存のシミにもアプローチ。抗酸化作用も。' },
      { name: 'ナイアシンアミド', desc: 'メラニンの移動にアプローチ。肌全体のトーンアップをサポート。' },
      { name: 'トラネキサム酸', desc: '炎症由来のシミ・色素沈着に特に有用な透明感ケア成分。' },
    ],
    keywords: ['くすみ', 'シミ', 'ブライトニング', 'トーンアップ', '色素沈着'],
  },
  {
    slug: 'anti-aging',
    ...
    concern: 'たるみ',
    skinType: null,
    intro: 'シワやたるみの原因は、コラーゲンの減少と肌の弾力低下。レチノールでコラーゲン産生をサポートし、ペプチドで肌のハリを取り戻す韓国スキンケアが注目されています。',
    ingredients: [
      { name: 'レチノール', desc: 'ビタミンA誘導体。コラーゲン産生をサポートし、シワをケアする王道成分。' },
      { name: 'ペプチド', desc: 'コラーゲンの合成を助け、肌のハリと弾力を回復させる。' },
      { name: 'PDRN（サーモンDNA）', desc: '細胞修復をサポートする次世代成分。韓国美容クリニック発。' },
    ],
