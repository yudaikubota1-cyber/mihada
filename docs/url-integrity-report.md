...
各公式ショップ内をWeb検索で確認し、同一商品が見つかった4件を公式ショップの
商品ページURLに更新（アフィリエイト転送URL → 公式ショップ直リンク）。

| 商品名 | 旧URL(店舗) | 新URL(公式ショップ) |
|---|---|---|
| Torriden ダイブインクレンジングフォーム | nagomi-pharmacy(アフィリエイト転送) | https://item.rakuten.co.jp/torriden-official/10000026/ |
| ファンケル エンリッチプラス 化粧液 | f253839-hino(アフィリエイト転送) | https://item.rakuten.co.jp/fancl-shop/3762-21/ |
| ファンケル サンガード50+ SPF50+PA++++ | rakuten24-cosmetics(アフィリエイト転送) | https://item.rakuten.co.jp/fancl-shop/3044-21/ |
| Abib ドクダミスポットパッド | 683street(アフィリエイト転送) | https://item.rakuten.co.jp/abibofficial/calmingtouch_pad/（Abib公式「カーミングタッチスポットパッド」＝ドクダミ/Heartleaf） |

### 更新せず現状維持（同一商品名が公式ショップに見つからず）

| 商品名 | 理由 |
|---|---|
| COSRX ワンステップモイスチャーアップパッド | COSRX公式(cosrx-official)には単品ページが見つからず、「ワンステップパッド3点セット」バンドルとカテゴリページのみ。同一単品が確認できないため現状URLを維持。 |
| ファンケル ホワイトニング 化粧液 | 公式(fancl-shop)では同名商品なし。後継の「ブライトニング 化粧液（医薬部外品）」(fancl-shop/3752-21/)に改称された可能性が高いが、DB上の商品名と異なるため現状維持・要判断。 |

## 3. 削除候補リスト（discontinued_candidate）

### キュレル（10件）→ 対応不要・現状維持（確定）

キュレルは花王の正規代理店網（ドラッグストア系含む）で販売されるのが通常で、
単独公式ショップという概念がないブランドのため、正規取扱店であれば問題なしと
判断。以下10件は**現状のURLを維持**する。

- 潤浸保湿 角層深部バリア美容液 / 潤浸保湿フェイスクリーム / UVケアジェル SPF50+PA+++ /
  クレンジングジェル / 泡立て洗顔料 / 潤浸保湿化粧水 II（しっとり）/ 潤浸保湿化粧水 I（さっぱり）/
  潤浸保湿美容液 / 皮脂トラブルケア化粧水 / 皮脂トラブルケアクリーム

### 過去の候補（下表）は §2 で対応済み

以下は当初ドメイン不一致だった商品。§2 のとおり4件を公式URLに更新、2件は
同一商品が見つからず現状維持とした。
